...
const VideoPart = () => {
  ...
  return (
    <div className="mt-4 w-full max-h-[550px]  rounded-md border border-gray-300">
      <div className="flex ">
      ...
      <div className="mt-5 w-full justify-center flex h-auto">
        <div className="w-[95%] h-[270px] border rounded-md z-[-20] flex justify-center items-center overflow-hidden">
